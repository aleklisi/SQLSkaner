...
namespace SQLSkaner
{
    public class Skaner
    {
        ...
        public List<FoundKeyWord> TokenizeInput()
        {
            ...
            {
                var inputSubstring = GetNextToken(ref startPosition, out var newFoundKeyWord);
        ...
        private string GetNextToken(ref int startPosition, out FoundKeyWord newFoundKeyWord)
        {
            ...
            newFoundKeyWord = GetLongestFoundKeyWord(currentPossibleFoundKeywordsList);
